...
export class VentaService {
  ...
  GetListProductsByIds(requestDetalle : DetalleVentaRequest[]) {
    return this.http.post<ApiProductoByFilterResponse>(this.UrlBase + 'Ventas/GetListProductsByIds', requestDetalle);
  }
}
